...
<s:layout-render name="/layout.jsp" titlekey="steward.title" >
    <s:layout-component name="body" >
        <s:useActionBean beanclass="pl.edu.uj.ii.ionb.airportmanager.web.beans.StewardsActionBean"
                         var="actionBean" />
            ...
            <table class="basic">
                ...
                <c:forEach items="${actionBean.stewards}" var="steward">
                    <tr>
                        ...
                        <th><s:link beanclass="pl.edu.uj.ii.ionb.airportmanager.web.beans.StewardsActionBean"
                                    event="editsteward">
                                    <s:param name="steward.id" value="${steward.id}"/>
